...
export const SignUp: React.FC = () => {
  ...
  const handleResendOTP = async () => {
    ...
    setError('');
    try {
      await api.auth.resendOTP(formData.email);
        ...
        <div className="p-8 md:w-2/3 overflow-y-auto max-h-[90vh]">
          {showOTP ? (
            <div className="max-w-md mx-auto py-12">
              ...
              <p className="text-gray-600 mb-8">We've sent a 6-digit verification code to <span className="font-semibold">{formData.email}</span>. Please enter it below to activate your account.</p>
              ...
              <form onSubmit={handleOTPVerify} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    maxLength={6}
                    placeholder="000000"
                    className="w-full border rounded-lg p-3 text-center text-2xl tracking-[1em] font-bold focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                    value={otp}
